...
const Registrar = () => {
    ...
    const handleRegister = async (e) => {
        ...
        // 💥 AHORA ES FIJO: Todos los usuarios registrados por esta vía NO son freelancers (Clientes)
        ...
        const registerData = {
            ...
            email,
            password,
            isFreelancer, // Enviamos false al backend
        };
        ...
        try {
            ...
            showCustomMessage(`Error en el registro: ${errorMsg}`);
